...
public class HR_Bar_Chart_GraphView extends View {
    ...
    public HR_Bar_Chart_GraphView(Context context, int[] values, String title, String[] yLabels, String[] xLabels, boolean type) {
        super(context);
