...
public class Speed_Bar_Chart_GraphView extends View {
    ...
    public Speed_Bar_Chart_GraphView(Context context, float[] values, String title, String[] yLabels, String[] xLabels, boolean type) {
        super(context);
        ...
        if(xLabels == null) this.yLabels = new String[0];
